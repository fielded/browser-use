...
async def main():
    ...
    try:
      ...
      await main_agent.run_agent(browser_session=browser_session, tasks="tasks/PSM/stock_report.yaml", feature="Stock Report")
      
      print("== Running Route forwarding agent ==")
      await main_agent.run_agent(browser_session=browser_session, tasks="tasks/PSM/route_forwarding.yaml", feature="Route Forwarding")
      
      print("== Running Analytics Exports agent ==")
      await main_agent.run_agent(browser_session=browser_session, tasks="tasks/PSM/analytics_exports.yaml", feature="Analytics Exports")
      
      print("== Running Main orders agent ==")
      await main_agent.run_agent(browser_session=browser_session, tasks="tasks/PSM/psm_orders.yaml", feature="PSM Orders")
